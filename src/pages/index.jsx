        ...
        <div className="container mx-auto px-4 pb-12 lg:w-3/4">
          ...
          <div>
            ...
            <p className="md:leading-7 md:text-xl md:mx-auto text-gray-700 lg:w-3/4 text-center mt-4">
              The DCCN-2023 conference is organized under the support of the IEEE Russia Section, Communications Society Chapter (COM19).
            </p>
          ...
          <div className="flex flex-col-reverse justify-center align-center xl:flex-row">
            <div className="py-12 text-gray-600 xl:w-1/2 ">
              <ul className="text-center list-disc ml-8 mt-8 m-auto text-xl xl:text-justify">
                <li className="mb-4">
                  <a target="_blank" href="https://2022.dccn.ru" className="text-blue-500 hover:underline">25th International Conference on Distributed Computer and Communication Networks DCCN 2022</a>
                </li>
                <li className="mb-4">
