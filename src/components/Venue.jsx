  ...
  return <div className="block">
    ...
    <div className="block">
      <p className="md:leading-7 md:text-xl md:mx-auto text-gray-700 mt-4">
        The DCCN-2023 conference will be held in a hybrid mode (with physical and virtual participation) in the premises of the V.A. Trapeznikov Institute of Control Sciences of Russian Academy of Sciences (ICS RAS).
      </p>
      <p className="md:leading-7 md:text-xl md:mx-auto text-gray-700 mt-4">
