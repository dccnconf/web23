  ...
  return (
    <div className={className}>
      ...
      <p className="md:leading-7 md:text-xl text-gray-700 my-4">
        Payment is possible in Russian rubles by wire transfer or in cash onsite. In order to pay the registration fee follow these steps:
      </p>
      ...
      <div className="mt-1">
        ...
        <p className="mt-4">Главный бухгалтер: Котельникова Наталья Николаевна, Тел.: 8-985-293-97-07, Почтовый адрес: 117525, г. Москва, Сумской проезд, д. 31, корп. 2, кв. 80</p>
      </div>
      ...
      <ul className="mt-1 text-gray-600 font-medium">
        <li className="mb-1">
          <a href="/downloads/agreement-fiz.doc" className="text-indigo-700" target="_blank">Agreement with an individual participant (Договор с физическим лицом)</a>
        </li>
        <li className="mb-1">
          <a href="/downloads/act-fiz.doc" className="text-indigo-700" target="_blank">Act to an agreement with an individual participant (Акт с физическим лицом)</a>
        </li>
        <li className="mb-1">
          <a href="/downloads/agreement-legal.doc" className="text-indigo-700" target="_blank">Agreement with a legal entity (Договор с юридическим лицом)</a>
        </li>
        <li className="mb-1">
      ...
      <p className="md:leading-7 md:text-xl text-gray-700 my-4">
        Send the scanned copies of the signed documents together with the payment confirmation to the Organizing Committee email:  <a href="mailto:org@dccn.ru" className="text-blue-600 hover:underline">org@dccn.ru</a>.
      </p>
      ...
      <p className="md:leading-7 md:text-xl text-gray-700 my-4">
        Please send the hard copies of the signed documents (договор + акт) by regular mail to the postal address of the chief accountant: 117525, г. Москва, Сумской проезд, д.31, корп.2, кв.80. Строго на имя Котельниковой Н.Н.
      </p>
      ...
      <div className="border rounded-xl bg-pink-100 border-red-300 px-6 py-4 mt-4 text-lg leading-7 text-gray-700">
        ...
        <p>
          ...
          <span className="font-bold">“ФИО участника(-ов). Оргвзнос за DCCN2023, в т.ч. НДС (20%) — X руб."</span>
      ...
      <div className="border rounded-xl bg-pink-100 border-red-300 px-6 py-4 mt-8 text-lg leading-7 text-gray-700">
        ...
        <p>
          In the purpose of payment, one should necessarily specify the amount of VAT (see the table of fees above), as well as the full name of the participant(s).
          Otherwise we will not be able to properly trace the payment and identify the payer.
        </p>
        <p>
          <span className="font-bold">Please specify in the MEMO LINE the following: “NAME SURNAME, DCCN2023 fee, incl. VAT (20%) — X RUB ”.</span>
