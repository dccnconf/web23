  ...
  return (
    <div className={className}>
      ...
      <div className="mt-1">
        ...
        <p className="mt-4">Главный бухгалтер: Котельникова Наталья Николаевна, Тел.: 8-916-688-48-93, Почтовый адрес: 117525, г. Москва, Сумской проезд, д. 31, корп. 2, кв. 80</p>
      </div>
